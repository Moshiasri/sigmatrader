...
{
	$con = mysql_connect("HOST", "fbsql_username(link_identifier)", "PASS");
if (!$con)
  {
...
Symbol: <input id ="ticker1" type="text" name="stock"></input>
</form>
  <div style="z-index:999"  style="height: 500px;"></div><textarea id="textarea1" rows="5" cols="80">textarea1</textarea>
...
setInterval(function() {
  ...
  if(canvas.width  != document.documentElement.clientWidth-300)
  {
    canvas.width  = document.documentElement.clientWidth-300; 
  }
...
<!-- File structure
    ...
    <footer class="footer">
      <div class="container">
        ...
        <p>Designed and built by  <a href="http://twitter.com/cjreeves2011" target="_blank">@cjreeves2011</a> </p>
